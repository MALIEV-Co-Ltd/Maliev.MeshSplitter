...
describe('exportPdf', () => {
  ...
  it('creates a MALIEV branded visual assembly packet with QR and part images', async () => {
    ...
    expect(completeImageCall[2]).toBeCloseTo(31.67, 1)
    expect(completeImageCall[3]).toBeCloseTo(90, 1)
    expect(completeImageCall[4]).toBeCloseTo(146.67, 1)
    expect(completeImageCall[5]).toBeCloseTo(110, 1)
