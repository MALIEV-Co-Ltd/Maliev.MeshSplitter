...
function addFooter(pdf, appUrl, pageNumber) {
  ...
  pdf.text(`Generated by MALIEV Mesh Splitter | ${appUrl}`, PDF_PAGE.margin, 286)
...
function addCoverHero(pdf, qrImage, appUrl) {
  ...
  pdf.text([
    'Generated locally in your browser by MALIEV Mesh Splitter. Use this packet together with the',
